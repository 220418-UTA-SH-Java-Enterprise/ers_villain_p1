...
public class RequestHelper {
    ...
    public static void processAllUsers(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        // 4. use a PrintWriter to write the objects to the response body which will be
        // seen in the browser
    ...
    public static void processUserBySearchParam(HttpServletRequest request, HttpServletResponse response)
            throws IOException {
        ...
        if (body.startsWith("id")) {
            ...
            // 3. Turn the list of Java Objects into a JSON string (using Jackson Databind
            // Object Mapper).
